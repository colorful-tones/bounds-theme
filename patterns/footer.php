...
<div class="wp-block-group has-link-color has-small-font-size" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			<!-- wp:paragraph -->
			<p><a href="#"><?php echo esc_html__( 'Mail', 'bounds' ); ?></a></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph -->
			<p><a href="#"><?php echo esc_html__( 'Instagram', 'bounds' ); ?></a></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph -->
			<p><a href="#"><?php echo esc_html__( 'Behance', 'bounds' ); ?></a></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph -->
			<p><a href="#"><?php echo esc_html__( 'LinkedIn', 'bounds' ); ?></a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group">
			<!-- wp:paragraph -->
			<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'bounds' ); ?></a></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph -->
			<p><a href="#"><?php echo esc_html__( 'Terms & Conditions', 'bounds' ); ?></a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( '© 2024', 'bounds' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<p class="has-text-align-right"><?php
			...
			$wordpress_link = '<a href="' . esc_url( __( 'https://wordpress.org', 'bounds' ) ) . '" rel="nofollow">WordPress</a>';
			echo sprintf(
				esc_html__( 'Designed with %1$s', 'bounds' ),
				$wordpress_link
			);
		?></p>
		<!-- /wp:paragraph -->
	...
	<!-- wp:pattern {"slug":"bounds/giant-footer-text"} /-->
</div>
<!-- /wp:group -->